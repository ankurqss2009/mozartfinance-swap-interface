import { CurrencyAmount, JSBI, Token, Trade, Currency, ETHER } from '@pancakeswap-libs/sdk'
...
console.log("loadedUrlParams",loadedUrlParams)
  ...
  const  toTokenCurrency = useCurrency("ETH")
          ...
          <CardBody>
            <AutoColumn gap="md">
              ...
              <CurrencyInputPanel
                ...
                label={
                  independentField === Field.OUTPUT && !showWrap && trade
                    ? TranslateString(194, 'To (estimated)')
                    : TranslateString(76, 'To')
                }
                showMaxButton={false}
