...
export function ListSelect({ onDismiss, onBack , isFromToken}: { onDismiss: () => void; onBack: () => void; isFromToken?:boolean }) {
  ...
  const fetchList = useFetchListCallback(isFromToken)
